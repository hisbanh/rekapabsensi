...
Optimized configuration for PythonAnywhere deployment.
"""
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'attendance.context_processors.notification_context',  # Notification count
            ],
        },
    },
]
...
# PythonAnywhere uses MySQL by default, but we'll keep SQLite for simplicity
DATABASES = {
    'default': {
...
# Cache configuration - Use local memory cache for PythonAnywhere
CACHES = {
    'default': {
